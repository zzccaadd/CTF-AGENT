...
def main(
    ...
    settings.solvers_per_swarm = solvers_per_swarm
    ...
    if challenge:
        asyncio.run(_run_single(settings, challenge, model_specs, no_submit, max_challenges, solvers_per_swarm))
    else:
        asyncio.run(_run_coordinator(settings, model_specs, challenges_dir, no_submit, coordinator_model, coordinator, max_challenges, solvers_per_swarm, msg_port))
...
async def _run_single(
    ...
    max_containers = max_challenges * len(model_specs) * solvers_per_swarm
    ...
    swarm = ChallengeSwarm(
        ...
        solvers_per_model=solvers_per_swarm,
        max_solvers=settings.max_solvers_per_swarm,
        no_submit=no_submit,
    )
